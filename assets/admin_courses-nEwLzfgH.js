import{r as B,p as E,l as C}from"./auth-qdlMy9e7.js";/* empty css              *//* empty css             *//* empty css                  */import{c as k,u as S,d as _,a as x,b as j,e as M,f as F,g as L,h as A,i as N,j as H,k as z,l as D,m as T,n as R,o as O,p as q}from"./admin-BW6SJvAW.js";import{i as J,s as o}from"./ui-CfSCUwhT.js";import"https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/+esm";import"./preload-helper-BKjL65nl.js";const P=await B(["admin"]);E(P);J();document.getElementById("logout-btn").addEventListener("click",C);let p=[];const g=["si-teal","si-gold","si-purple","si-rose","si-blue"];async function d(){try{[p]=await Promise.all([O("teacher")]);const t=await q();Y(t)}catch(t){o(t.message,"error")}}function U(t){return'<option value="">— ගුරුවරයෙක් තෝරන්න —</option>'+p.map(n=>`<option value="${n.id}" ${n.id===t?"selected":""}>${n.full_name}</option>`).join("")}function Y(t){const n=document.getElementById("hierarchy-container");if(!t.length){n.innerHTML='<div class="empty-row">Sections නොමැත. ඉහළ බොත්තම මගින් එකක් එකතු කරන්න.</div>';return}n.innerHTML=t.map((e,r)=>`
...
${a}`);let i=e;if(s!==null){const c=parseInt(s);i=c>0&&c<=p.length?p[c-1].id:null}try{await L(t,r,i),o("Subject යාවත්කාලීන කරන ලදී","success"),d()}catch(c){o(c.message,"error")}};window.delSubject=async(t,n)=>{if(confirm(`"${n}" Subject එක මකා දැමිය යුතුද?`))try{await A(t),o("Subject මකා දමන ලදී","success"),d()}catch(e){o(e.message,"error")}};window.showAddCourse=t=>{const n=document.getElementById(`add-course-${t}`);n.style.display=n.style.display==="none"?"flex":"none"};window.saveCourse=async t=>{const n=document.getElementById(`course-name-${t}`).value.trim(),e=document.getElementById(`course-months-${t}`).value,r=document.getElementById(`course-fee-${t}`).value||2500,a=document.getElementById(`course-free-${t}`).checked;if(!n)return o("Course නමක් ඇතුළත් කරන්න","warning");try{await N(t,n,e,r,a),o("Course එකතු කරන ලදී ✅","success"),d()}catch(s){o(s.message,"error")}};window.editCourse=async(t,n,e,r)=>{const a=prompt("Course නම වෙනස් කරන්න:",n);if(!a)return;const s=prompt("ගාස්තුව (රු.):",e||2500),i=confirm("මෙම පාඨමාලාව සම්පූර්ණයෙන්ම නොමිලේ ලබා දෙන එකක්ද?");try{await H(t,a,s||2500,i),o("Course යාවත්කාලීන කරන ලදී","success"),d()}catch(c){o(c.message,"error")}};window.delCourse=async(t,n)=>{if(confirm(`"${n}" Course එක මකා දැමිය යුතුද?`))try{await z(t),o("Course මකා දමන ලදී","success"),d()}catch(e){o(e.message,"error")}};let l=null;window.openMonthModal=t=>{const n=typeof t=="string"?JSON.parse(t):t;l=n,document.getElementById("modal-course-title").textContent=`${n.name} - මාස කළමනාකරණය`,document.getElementById("new-m-year").value=new Date().getFullYear(),document.getElementById("new-m-num").value="",document.getElementById("new-m-name").value="",document.getElementById("new-m-sheet").value="",document.getElementById("new-m-deadline").value="14",document.getElementById("new-m-free").checked=!1,h(n.course_months||[]),document.getElementById("month-modal").classList.add("active")};window.closeMonthModal=()=>{document.getElementById("month-modal").classList.remove("active"),l=null,d()};function h(t){const n=document.getElementById("modal-month-list");if(!t.length){n.innerHTML='<div style="text-align:center;padding:1rem;color:var(--text-muted)">මාස කිසිවක් එක් කර නොමැත.</div>';return}t.sort((e,r)=>e.year!==r.year?e.year-r.year:e.month_number-r.month_number),n.innerHTML=t.map(e=>`
  ...
  `).join("")}window.saveNewMonth=async()=>{if(!l)return;const t=parseInt(document.getElementById("new-m-year").value),n=parseInt(document.getElementById("new-m-num").value),e=document.getElementById("new-m-name").value.trim(),r=document.getElementById("new-m-sheet").value.trim(),a=parseInt(document.getElementById("new-m-deadline").value)||14,s=document.getElementById("new-m-free").checked;if(!t||!n||!e)return o("අවුරුද්ද, මාසයේ අංකය සහ නම අනිවාර්යයි!","warning");try{const i=await D(l.id,t,n,e,r,a,s);l.course_months||(l.course_months=[]),l.course_months.push(i),h(l.course_months),o("නව මාසය එකතු කරන ලදී ✅","success"),document.getElementById("new-m-num").value="",document.getElementById("new-m-name").value="",document.getElementById("new-m-sheet").value="",document.getElementById("new-m-deadline").value="14",document.getElementById("new-m-free").checked=!1}catch(i){i.code==="23505"?o("මෙම මාසයේ අංකය දැනටමත් පවතී!","error"):o(i.message,"error")}};window.editMonthItem=async(t,n,e,r,a,s,i)=>{const c=prompt("අවුරුද්ද:",n);if(!c)return;const y=prompt("මාසයේ අංකය (1-12):",e);if(!y)return;const w=prompt("මාසයේ නම:",r);if(!w)return;const v=prompt("Google Sheet Link:",a),$=prompt("Deadline දිනය (1-31):",s),f=parseInt($)||14,b=confirm("මෙම මාසය නොමිලේ දෙන එකක්ද? (Free)");try{await T(t,parseInt(c),parseInt(y),w,v||"",f,b);const u=l.course_months.find(I=>I.id===t);u&&(u.year=parseInt(c),u.month_number=parseInt(y),u.name=w,u.google_sheet_url=v||null,u.payment_deadline_date=f,u.is_free=b),h(l.course_months),o("මාසය යාවත්කාලීන කරන ලදී","success")}catch(u){o(u.message,"error")}};window.delMonthItem=async(t,n)=>{if(confirm(`"${n}" මාසය මකා දැමිය යුතුද?`))try{await R(t),l.course_months=l.course_months.filter(e=>e.id!==t),h(l.course_months),o("මාසය මකා දමන ලදී","success")}catch(e){o(e.message,"error")}};document.getElementById("month-modal").addEventListener("click",t=>{t.target.id==="month-modal"&&closeMonthModal()});d();
