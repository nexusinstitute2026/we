import{r as u,p as g,l as p}from"./auth-8lOPc_Ms.js";/* empty css              *//* empty css             *//* empty css                  */import{a as h,r as y,g as f}from"./payment-BOiYUFGx.js";import{i as v,s as i,a as b}from"./ui-CfSCUwhT.js";import"https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/+esm";const w=await u(["admin"]);g(w);v();document.getElementById("logout-btn").addEventListener("click",p);let s=[],a="pending";async function x(n,e=[]){try{return await n}catch(r){return console.error("Fetch error:",r),e}}async function o(){s=await x(f(),[]);const n=s.filter(r=>r.status==="pending").length,e=document.getElementById("cnt-pending");e&&(e.textContent=n),l()}function l(){const n=document.getElementById("payments-container");let e=s;if(a!=="all"&&(e=s.filter(t=>t.status===a)),!e.length){n.innerHTML=`<div style="text-align:center;padding:3rem;background:#fff;border-radius:var(--radius-xl);border:1px dashed #cbd5e1">
