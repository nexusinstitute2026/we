import{r as h,p as f,l as v}from"./auth-5l32Gasm.js";/* empty css              *//* empty css             *//* empty css                  */import{a as b,r as w,g as x}from"./payment-RUGV7WNt.js";import{z as _,A as $,D as k}from"./admin-BPFFsS_i.js";import{i as E,s,a as A}from"./ui-CfSCUwhT.js";import"https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/+esm";import"./preload-helper-BKjL65nl.js";const B=await h(["admin"]);f(B);E();document.getElementById("logout-btn").addEventListener("click",v);let l=[],o="pending",c="",m="";async function L(n,a=[]){try{return await n}catch(e){return console.error("Fetch error:",e),a}}async function u(){l=await L(x(),[]);const n=l.filter(e=>e.status==="pending").length,a=document.getElementById("cnt-pending");a&&(a.textContent=n),g()}function g(){const n=document.getElementById("payments-container"),a={1:"ජනවාරි",2:"පෙබරවාරි",3:"මාර්තු",4:"අප්‍රේල්",5:"මැයි",6:"ජූනි",7:"ජූලි",8:"අගෝස්තු",9:"සැප්තැම්බර්",10:"ඔක්තෝබර්",11:"නොවැම්බර්",12:"දෙසැම්බර්"};if(o==="manual"){const t=l.filter(r=>r.slip_drive_link==="manual_assign");let i="";t.length?i=t.map(r=>{const d=r.payment_courses?.map(y=>y.course?.name).filter(Boolean).join(", ")||"—",p=r.paid_month?`${r.paid_year||""} ${a[r.paid_month]||r.paid_month}`:"—";return`
