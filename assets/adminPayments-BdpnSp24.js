import{c as l,p as d,d as c,f as m,s as r,g as u}from"./ui-DbSpmO8X.js";/* empty css              *//* empty css                  */import{c as g,r as f,a as p}from"./payment-DH-CEloy.js";const y=await l(["admin"]);d(y);c();document.getElementById("logout-btn").addEventListener("click",m);let i=[],s="pending";async function h(n,e=[]){try{return await n}catch(t){return console.error("Fetch error:",t),e}}async function a(){i=await h(p(),[]);const n=i.filter(t=>t.status==="pending").length,e=document.getElementById("cnt-pending");e&&(e.textContent=n),o()}function o(){const n=document.getElementById("payments-container");let e=i;if(s!=="all"&&(e=i.filter(t=>t.status===s)),!e.length){n.innerHTML=`<div style="text-align:center;padding:3rem;background:#fff;border-radius:var(--radius-xl);border:1px dashed #cbd5e1">
