import{r as p,p as y,l as h}from"./auth-5l32Gasm.js";/* empty css              *//* empty css             *//* empty css                  */import{D as b,E as f,F as E,v as u}from"./admin-BXWvPR6F.js";import{i as B,o as m,c,s as a}from"./ui-CfSCUwhT.js";import"https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/+esm";import"./preload-helper-BKjL65nl.js";const I=await p(["admin"]);y(I);B();document.getElementById("logout-btn").addEventListener("click",h);window.openModal=m;window.closeModal=c;const l=["var(--g-teal)","var(--g-gold)","var(--g-purple)","var(--g-rose)","var(--g-blue)"];let d=[],s=[];async function i(t,n=[]){try{return await t}catch(e){return console.error("Fetch error:",e),n}}async function o(){d=await i(u("teacher"),[]),s=await i(u("student"),[]),document.getElementById("teacher-count").textContent=`(${d.length})`,document.getElementById("student-count").textContent=`(${s.length})`,g(d),v(s)}function g(t){const n=document.getElementById("teachers-grid");if(!t.length){n.innerHTML='<p style="color:var(--text-muted)">ගුරුවරුන් නොමැත.</p>';return}n.innerHTML=t.map((e,r)=>`
    <div class="user-card">
