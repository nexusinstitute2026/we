import{r as v,p as w,l as E}from"./auth-qdlMy9e7.js";/* empty css              *//* empty css             *//* empty css                  */import{q as y,r as b,o as x,p as $,s as M,t as B,v as I,w as L}from"./admin-BW6SJvAW.js";import{i as A,s as a}from"./ui-CfSCUwhT.js";import"https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/+esm";import"./preload-helper-BKjL65nl.js";const _=await v(["admin"]);w(_);A();document.getElementById("logout-btn").addEventListener("click",E);let g=[];async function k(e,t=[]){try{return await e}catch(n){return console.error("Fetch error:",n),t}}async function d(){g=await k(L(),[]),f(g)}function f(e){const t=document.getElementById("enroll-list-container");if(!e.length){t.innerHTML=`<div style="text-align:center;padding:3rem;background:#fff;border-radius:var(--radius-xl);border:1px dashed #cbd5e1">
